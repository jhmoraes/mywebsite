...
import { listProject } from '../constants/listProject'
...
const GlobalState = (props) => {
    ...
    const data = { lightTheme, colorBackground, colorText, colorTextMenu, colorTextHeader, colorShadowCard, showProject}
